...
`;
  ...
  return (
    <Styles>
      {/* fixed background */}
      <div className="bgContentPortrait"></div>

      {/* CONTENT */}
      <div className="headerTitles3">
        <h2>Welcome to</h2>
      ...
      <div className="centerContent">
        <div className="centerContentIns2">
         ...
         <div className="languageSecPort"> 
          ...
          <div className="phoneSectionCenter">
            {/* background phone */}
